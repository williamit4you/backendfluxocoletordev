...
public record StepApiConfigDto(string? Url, string? Method, string? TokenName, string? ScheduleMode, string? ScheduleValue, string? QueryTemplate, bool ValidateTls, IReadOnlyList<string>? SendFieldKeys = null, IReadOnlyList<ResponseFieldMappingDto>? ResponseMappings = null, IReadOnlyList<BodyFieldMappingDto>? BodyMappings = null, StepScheduleAssistDto? ScheduleAssist = null, IReadOnlyList<RequestHeaderDto>? Headers = null, string? BodyTemplate = null, bool RetryOnEmptyArray = false, int? EmptyArrayRetryMinutes = null);
