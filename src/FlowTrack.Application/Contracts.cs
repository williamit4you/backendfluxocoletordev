...
public record ChangeOwnPasswordRequest(string NewPassword, string ConfirmPassword);
...
public record ResponseRuleDto(bool Enabled = false, string? TargetPath = "$", string? ExpectedType = "array", string? EmptyBehavior = "advance", string? NonEmptyBehavior = "advance", int? RetryIntervalMinutes = null, int? MaxAttempts = null, string? FailureBehavior = "fail", string? Description = null, string? Mode = "emptyCheck", string? Operator = null, string? ExpectedValue = null, bool? CaseSensitive = null, string? OnMatchBehavior = null, string? OnMismatchBehavior = null, string? TransportErrorBehavior = "fail", int? TransportRetryIntervalMinutes = null, int? TransportMaxAttempts = null, string? HttpErrorBehavior = "fail", int? HttpErrorRetryIntervalMinutes = null, int? HttpErrorMaxAttempts = null);
